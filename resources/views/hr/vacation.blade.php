        ...
        <div class="modal-body">
            ...
            <div class="form-outline">
                <select name="edit_status"  class="form-control">
                  ...
                  <option value="wating">قيد المراجعة</option>
                  <option value="rejected">مرفوضة</option>
                  <option value="suspension">متعلقة</option>
                  <option value="done">موافقة</option>
                </select>
                <input type="hidden" name="" id="">
                <label class="form-label" for="form12"> حالة الطلب </label>
            </div>
            <br>
            <div class="form-outline">
              <textarea required name="edit_note_admin" id="note_admin" class="form-control" cols="3" rows="3"></textarea>
              <label class="form-label" for="form12"> ملاحظات  المشرف</label>
          </div>
