...
<div class="container new-invoice">
  <form method="POST" action="{{ route('store.buying.medicines.pharmacy')}}">
    <h2> فاتورة جديدة </h2>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <label for=""> التخزين  </label>
        <select name="invoice_type" id="" class="form-control">
          <option value="purchases"> صيدلية </option>
          <option value="return_purchases">مخزن الصيدلية</option>
        </select>
      </div>
    </div>
