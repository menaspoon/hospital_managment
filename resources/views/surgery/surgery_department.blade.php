...
{{------------------------------  رسالةانشاء وتحديث البيانات  -----------------------------}}
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <form action="{{ route("store.surgery") }}" method="POST" class="modal-content" enctype="multipart/form-data" >
        @csrf
        ...
        <div class="modal-body">
            ...
            <br>
            <div class="form-outline">
                <input type="text" required name="price" id="form12" class="form-control" />
  ...
  <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="EditModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <form action="{{ route("update.surgery") }}" method="POST" class="modal-content" enctype="multipart/form-data" >
        @csrf
        <div class="modal-header">
        ...
        <div class="modal-body">
            ...
            <br>
            <div class="form-outline">
                <input type="text" required name="edit_price" id="price" class="form-control" />
                <label class="form-label" for="form12"> السعر  </label>
            </div>
            <br>
        </div>
