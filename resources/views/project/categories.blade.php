    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions"> 
                  <a data-id="{{ $item->id }}" data-table="category" class="delete"><i class="far fa-trash-alt"></i></a>
                  <a data-id="{{ $item->id }}" data-bs-toggle="modal" data-bs-target="#EditModal"><i class="far fa-pencil-alt"></i></a>
                </td>
              </tr>
            @endforeach
        </tbody>
