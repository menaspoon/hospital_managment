...
class EmergencyDepartmentController extends Controller {
  ...
  function index() {
      ...
      $categories  = EmergencyDepartment::where("hospital", $acount->hospital)->get();
      return view("emergency.emergency_department", compact("categories"));
  }
  ...
  function edit(Request $request) {
    if($request->ajax()) {
      $id = $request->get('id');
      $data = EmergencyDepartment::where('id', $id)->first();
  ...
  function  update(Request $request) {
    ...
    EmergencyDepartment::where("id", $request->id)->update([
